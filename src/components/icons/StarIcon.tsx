...
const StarIcon = ({ fill = true, size = "lg" }: { fill?: boolean, size?: string }) => {
    return (
        <svg
            width={`${size === "xl" ? "40px" : size === "lg" ? "24px" : "18px"}`}
            height={`${size === "xl" ? "40px" : size === "lg" ? "24px" : "18px"}`}
            viewBox="0 0 24 24"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
        >
            <path
                className={cn(``, { "fill-star_on": fill, "fill-gray": !fill })}
