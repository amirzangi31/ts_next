...
export const metadata = {
  ...
  openGraph: {
    "og:title" : "آرناپ : نوبت دهی اینترنتی پزشکان | مشاوره و ویزیت آنلاین",
    "og:description" : 'با سامانه آنلاین آرناپ از جستجو و دریافت نوبت از پزشکان و کلینیک ها و درمانگاه ها و بیمارستان ها تا مشاوره و ویزیت آنلاین را داشته باشید',
    "og:url" : "https://dev.arenapp.ir",
  },
